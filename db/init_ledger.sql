...
INSERT INTO lon_acct_base (
    acct_no, acct_seq_no, cust_no, acct_stat_cd, item_cd, apply_no, approval_no,
    ...
    repay_method_cd, virtual_acct_no
) VALUES
    -- 1) 주택담보대출, 원리금균등, 정상 진행중
    ('20210610010001', 1, '2021000045', '01', '01', NULL, NULL,
     600000000, 512340000, '20210610', '20510610',
     '20260810', '20260810', '20260710', '20260710', NULL,
     '10', 0.032000, 0.009000, 0.041000, 0.012000,
     '01', NULL),

    -- 2) 중도금대출 1차 실행분 -- 아래 3)과 acct_no가 동일, acct_seq_no로만 구분됨
    ('20240301010005', 1, '2024000078', '01', '01', NULL, NULL,
     400000000, 150000000, '20240301', '20280301',
     '20260901', '20260901', '20260801', '20260801', NULL,
     '01', 0.034000, 0.010000, 0.044000, 0.015000,
     '01', NULL),

    -- 3) 중도금대출 2차 실행분 -- 2)와 같은 acct_no("20240301010005"), acct_seq_no만 2로 다름
    ('20240301010005', 2, '2024000078', '01', '01', NULL, NULL,
     400000000, 140000000, '20240901', '20280301',
     '20260901', '20260901', '20260801', '20260801', NULL,
     '01', 0.036000, 0.010000, 0.046000, 0.015000,
     '01', NULL),

    -- 4) 전세자금대출, 만기일시상환 -- 만기 전까지 원금상환 이력이 없어 last_repay_dt는 신규일자로 baseline
    ('20250815020002', 1, '2025000012', '01', '02', NULL, NULL,
     300000000, 300000000, '20250815', '20270815',
     '20260815', '20270815', '20260715', '20250815', NULL,
     '15', 0.038000, 0.006000, 0.044000, 0.010000,
     '03', NULL),

    -- 5) 신용대출, 원금균등, 만기 도래 후 정상 해지 (잔액 0)
    ('20220920030007', 1, '2022000391', '04', '03', NULL, NULL,
